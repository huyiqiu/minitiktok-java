...
//            httpProfile.setReqMethod("POST"); // 默认使用POST
            ...
            req.setSmsSdkAppId("1400638641");   // 短信应用ID: 短信SdkAppId在 [短信控制台] 添加应用后生成的实际SdkAppId
            req.setSignName("胡义秋秋秋");         // 签名
            req.setTemplateId("1316389");       // 模板id：必须填写已审核通过的模板 ID。模板ID可登录 [短信控制台] 查看
